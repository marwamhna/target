...
class HttpClient {
    ...
    getRequest(relativePath, options) {
        const internalOptions = { retry: true, method: 'get' };
    ...
    sendRequest(relativePath, options) {
        ...
        return result.then((response) => response.body, (err) => __awaiter(this, void 0, void 0, function* () { return this.handleHttpError(options, err, relativePath, fullUrl); }));
    }
    handleHttpError(options, err, relativePath, fullUrl) {
